...
class Index extends Action
{
    ...
    public function execute()
    {
        ...
        $logger->info("VendorProductIndexController: Security check for Customer ID: " . var_export($customerId, true));
        ...
        if (!$vendor->getId()) {
            $logger->warning("VendorProductIndexController: Unauthorized access attempt or missing vendor record for Customer $customerId. Logging out.");
